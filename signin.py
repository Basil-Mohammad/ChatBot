...
def forget_pass():
    def change_password():
        if user_entry.get()=='' or newpass_entry.get()=='' or confirmpass_entry.get()=='':
            ...
            con=pymysql.connect(host='localhost', user='root', password='0000', database='userdata')
            mycursor=con.cursor()
    ...
    bgPic = ImageTk.PhotoImage(file='respass.jpg')
...
AdminButton=Button(login_window, text='Admin Login', bd=0, bg='white', activebackground='white', cursor='hand2', font=('Microsoft Yahei UI Light', 9, 'bold'), fg='firebrick1', activeforeground='firebrick1', command=admin_login)
AdminButton.place(x=580,y=295)
